...
function sitemapBody(entries = EXPECTED_SITEMAP_ENTRIES) {
  return [
    ...
    ...entries.map(({ url, changeFrequency, priority, lastModified }) => [
      "<url>",
      `<loc>${url}</loc>`,
...
test("requires the exact ordered sitemap serializer contract", () => {
  ...
  assert.deepEqual(EXPECTED_SITEMAP_ENTRIES, [
    ...
    { url: "https://webtaskkit.com/seo-tools", changeFrequency: "monthly", priority: "0.8", lastModified: "2026-09-01T06:50:35.918Z" },
    { url: "https://webtaskkit.com/about", changeFrequency: "monthly", priority: "0.3", lastModified: "2026-09-01T06:50:35.918Z" },
    { url: "https://webtaskkit.com/privacy", changeFrequency: "monthly", priority: "0.3", lastModified: "2026-09-01T06:50:35.918Z" },
