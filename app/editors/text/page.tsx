...
export const metadata: Metadata = { title: "Free Online Text Editor - Write & Download", description: "Write, clean and transform plain text with live counts, then copy or download it privately.", alternates: { canonical: "/editors/text" } };
