...
export const metadata: Metadata = { title: "Free Online SVG Editor - Edit & Export", description: "Open or paste SVG code, preview changes safely and export a clean SVG locally in your browser.", alternates: { canonical: "/editors/svg" } };
