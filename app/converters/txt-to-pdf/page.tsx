...
export const metadata: Metadata = { title: "TXT to PDF Converter - Free & Private", description: "Convert pasted text or a TXT file into a clean PDF in your browser. Choose page size and typography, with no upload." };
