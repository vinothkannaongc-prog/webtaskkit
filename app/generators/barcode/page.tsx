...
export const metadata: Metadata = { title: "Free Barcode Generator - UPC, EAN & Code 128", description: "Generate Code 128, UPC, EAN and ITF barcodes in your browser, then download SVG or PNG.", alternates: { canonical: "/generators/barcode" } };
