...
export const metadata: Metadata = { title: "Online Tone Generator - Frequency & Waveform", description: "Generate sine, square, triangle or sawtooth tones by frequency safely in your browser.", alternates: { canonical: "/generators/tone" } };
